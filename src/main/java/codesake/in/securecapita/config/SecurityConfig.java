...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(abstractHttpConfigurer->abstractHttpConfigurer.disable())
                ...
                .authorizeHttpRequests(auth->auth.requestMatchers("api/v1/user/signUp","api/v1/user/login","api/v1/user/confirmUserAccount").permitAll().anyRequest().authenticated())
